...
export const metadata: Metadata = {
  ...
  title: {
    default:
      "पंचकल्याणक प्रतिष्ठा महोत्सव 2026 | बांसवाड़ा | ह्रींकार तीर्थ",
    template: "%s | ह्रींकार तीर्थ पंचकल्याणक 2026",
  },
  description:
    "बांसवाड़ा में आयोजित भव्य पंचकल्याणक प्रतिष्ठा महा-महोत्सव 2026। 500+ जिनबिंब प्रतिष्ठा, शिलान्यास एवं आचार्य श्री विराग सागर जी की दिव्य सन्निधि में। 19–24 फरवरी 2026।",

  /* ── Keywords (extended LSI cluster) ──────────── */
  keywords: [
    "पंचकल्याणक प्रतिष्ठा 2026",
    "बांसवाड़ा पंचकल्याणक",
    "जैन पंचकल्याणक महोत्सव",
    "Panchkalyanak Pratishtha 2026",
    "Banswara Panchkalyanak",
    "Jain Panchkalyanak Mahotsav",
    "जैन मंदिर शिलान्यास",
    "जिनबिंब प्रतिष्ठा",
    "जैन धार्मिक कार्यक्रम",
    "Jain Mandir Shilanyas",
    "Jinbimb Pratishtha",
    "Jain Dharmik Karyakram",
    "ह्रींकार तीर्थ",
    "Hrimkar Tirth",
    ...
    "Jain religious event Rajasthan 2026",
    "पंचकल्याणक 2026",
  ...
  /* ── Author / Publisher ────────────────────────── */
  authors: [{ name: "ह्रींकार तीर्थ पंचकल्याणक समिति", url: "https://hrimkartirth.com" }],
  creator: "Nirgranth Creation",
  publisher: "चतुर्विंशती तीर्थंकर समिति, वात्सल्य सेवार्थ फाउंडेशन",

  /* ── Canonical / Alternate ─────────────────────── */
  metadataBase: new URL("https://hrimkartirth.com"),
  alternates: {
    canonical: "https://hrimkartirth.com/",
    languages: {
      "hi-IN": "/",
      "en-IN": "/",
    },
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "@graph": [
                ...
                {
                  "@type": "WebSite",
                  "@id": "https://hrimkartirth.com/#website",
                  url: "https://hrimkartirth.com",
                  ...
                  potentialAction: {
                    ...
                    target: {
                      "@type": "EntryPoint",
                      urlTemplate:
                        "https://hrimkartirth.com/?s={search_term_string}",
                    },
                ...
                {
                  "@type": "Event",
                  "@id": "https://hrimkartirth.com/#event",
                ...
                /* 4. LocalBusiness / Religious Organization */
                {
                  ...
                  "@id": "https://hrimkartirth.com/#localbusiness",
                  name: "ह्रींकार तीर्थ",
                  ...
                  url: "https://hrimkartirth.com",
                  telephone: "+91-88390-17577",
                  image: "https://hrimkartirth.com/logo.png",
                  address: {
                    "@type": "PostalAddress",
                    streetAddress: "बांसवाड़ा–उदयपुर रोड, टिम्बा गामड़ी",
                    addressLocality: "Banswara",
                ...
                {
                  "@type": "BreadcrumbList",
                  "@id": "https://hrimkartirth.com/#breadcrumb",
                  itemListElement: [
                    {
                      "@type": "ListItem",
                      position: 1,
                      name: "Home",
                      item: "https://hrimkartirth.com",
                    },
                  ],
                },
